...
const mysql           = require('mysql2/promise.js'); // fast mysql driver
const Debug           = require('debug');             // small debugging utility
const { performance } = require('perf_hooks');        // nodejs.org/api/perf_hooks.html
...
class MysqlDb {
    ...
    static connectionParams() {
        ...
        const dbConfig = env === 'dev' ? require("../business/config.js")["mysql"]["dev"] : require("../business/config.js")["mysql"]["prod"];
